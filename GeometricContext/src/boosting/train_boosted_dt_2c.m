...
cl = [-1 1];
y = labels;
label_y=arrayfun(@(x) mat2str(x), labels, 'UniformOutput', false); 
...
for t = 1:num_iterations
    ...
    dt = treefitw(features, label_y, w, 1/num_data/2, 'catidx', cat_features, 'method', 'classification', 'maxnodes', nodespertree*4);
