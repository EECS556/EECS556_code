...
for c = 1:num_classes
    ...
    y = (gid == c)*2-1;
    label_y=arrayfun(@(x) mat2str(x), y, 'UniformOutput', false);
    cl = [-1 1];
    nc = 2;
    w = zeros(num_data, 1);
    ...
    for t = 1:num_iterations
        ...
        dt = treefitw(features, label_y, w, 1/num_data/2, 'catidx', cat_features, 'method', 'classification', 'maxnodes', num_nodes*4);
